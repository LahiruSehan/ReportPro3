...
class ZohoLedgerApp {
    ...
    let content = `
      <div class="flex justify-between items-start mb-12">
        <div class="flex-grow">
          ...
          <h1 class="text-3xl font-black uppercase tracking-tighter text-indigo-900" contenteditable="true">Project: ${org.name || 'N/A'}</h1>
  ...
  downloadPDF() {
    ...
    html2pdf().set({
      ...
      html2canvas: { scale: 3.5, useCORS: true, letterRendering: true, antialiasing: true },
  ...
  autoFitZoom() {
    ...
    // Increased targetH for a "bigger" preview feel
    const targetH = wrapperH * 0.90; 
